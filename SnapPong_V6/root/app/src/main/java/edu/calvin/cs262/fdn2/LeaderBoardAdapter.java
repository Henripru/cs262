...
public class LeaderBoardAdapter extends RecyclerView.Adapter<LeaderBoardAdapter.LeaderBoardViewHolder> {
    ...
    private List<Player> myPlayersList;
    private Context mContext;

    public LeaderBoardAdapter(Context context, LiveData<List<Player>> playerList){
        this.myPlayersList = playerList.getValue();
    ...
    public void onBindViewHolder(@NonNull LeaderBoardViewHolder holder, final int position) {
        ...
        holder.elo.setText(Double.toString(myPlayersList.get(position).getMyELO()));

...
public class LeaderBoardScreen extends AppCompatActivity {
    ...
    private SnapPongViewModel mySnapPongViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SnapPongViewModel spView = new SnapPongViewModel(getApplication());
        LiveData<List<Player>> playersList = spView.getAllPlayers();

        //we pass into our adapter random elos and win rates to be displayed every time
        LeaderBoardAdapter adapter = new LeaderBoardAdapter(this, playersList);
